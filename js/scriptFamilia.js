...
let banderas = ["f_abuela.png","f_abuelo.png","f_madre.png","f_padre.png","f_hermana.png","f_hermano.png"];

//arreglo que guardara la opcion correcta
let correcta = [0,1,2,0,1,2];

//arreglo que guardara los paises a mostrar en cada jugada
let opciones = [];
//cargo en el arreglo opciones las opciones a mostrar en cada jugada
opciones.push(["GRANDMOTHER",      "GRANMOTHER",    "GRANDMODER"]);
opciones.push(["GRANFATHER",   "GRANDFATHER",  "GRANDFATER"]);
opciones.push(["MODHER","MODER", "MOTHER"]);

opciones.push(["FATHER",    "FADER",    "FADHER"]);
opciones.push(["SISTHER", "SISTER", "SISTEER"]);
opciones.push(["BRODHER",   "BROUTHER",  "BROTHER"]);
